...
public class OrderController {
	...
	// 해당 코드의 장바구니를 가져와서 p_info_dcode를 통해서 상품 정보를 읽고 ordertbl(구매정보)에 상품 상세코드와 수량,
	// user_code, user_class를 넣는다.
	// 그리고 나머지 주문일 수령자 연락처 등등은 입력을 통해서 받아서 넣어주기 : 이것은 dao에서 vo에 저장하고 for문을 돌리면서 vo를
	// 불러서 계쏙 저장하는 식으로 사용하자.(중복되는 정보니까)
	...
	public String payfin(Model model, int total, int count, String name, String address, String detail, String tel,
			String want) {
