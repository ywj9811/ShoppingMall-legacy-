      ...
      <div class="accordion" id="accordionPanelsStayOpenExample">
         ...
         <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseTwo"
               ...
               <div class="accordion-body">
                  ...
                  <form>
                     <div>닉네임 : ${vo.user_nick }</div>
                     <input class="form-control" name="nick" onchange="nick_change();">
         ...
         <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseFour"
               ...
               <div class="accordion-body">
                  <div>현재 휴대 전화</div>
                  <input class="form-control" value="${vo.user_tel }" disabled>
                  <form>
                     <div>
               ...
               <div class="accordion-body">
                  <form>
                     ...
                     <div class="user_addr_c">
                        주소 :<input class="form-control" id="addr" name="user_addr">
                     </div>
                     <div>
                        상세 주소 : <input class="form-control" name="user_daddr">
                     </div>
         ...
         <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseSix"
               ...
               <div class="accordion-body">
                  ...
                  <form>
                     <input class="form-control" name="user_email1" id="user_email1"
                        style="width: 300px; display: inline-block;"><a>@</a> <input
                        class="form-control" name="user_email2" id="user_email2"
                        style="width: 300px; display: inline-block;" disabled
                        value="선택해주세요"> <select class="form-select"
                        style="width: 300px; display: inline-block;" name="selectEmail"
                        id="selectEmail">
            ...
            <div id="panelsStayOpen-collapseSeven"
               ...
               <div class="accordion-body">
                  ...
                  <form>
                     <div>아이디 : ${vo.user_id }</div>
                     <div>
                        비밀번호 : <input class="form-control" name="user_pw1"
                           type="password">
                     </div>
                     <div>
                        비밀번호 재 입력 : <input class="form-control" name="user_pw2"
                           type="password"> <input type="button" value="회원 탈퇴"
                           placeholder="비밀 번호를 입력하세요" onclick="del(this.form)">
                     </div>
                  </form>
               </div>
            </div>
